...
//  Logika simpan/edit alamat TIDAK diubah.
// ═══════════════════════════════════════════════════════════════════
...
class _AddressFormScreenState extends State<AddressFormScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // Dibungkus post frame agar navigasi pop tidak mengunci (lock) engine Flutter
      ...
      child: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 14),
            // Row dua kolom: masing-masing Expanded agar responsif dan
            // tidak overflow horizontal di layar sempit (mis. 320px).
            Row(children: [
            ...
            DropdownButtonFormField<String>(
              ...
              isExpanded: true,
              items: _provinces.map((p) => DropdownMenuItem(value: p, child: Text(p, style: const TextStyle(fontSize: 13), overflow: TextOverflow.ellipsis))).toList(),
