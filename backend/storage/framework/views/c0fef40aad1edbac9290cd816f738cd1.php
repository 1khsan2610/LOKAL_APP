    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 login-gradient relative items-center justify-center p-12">
            <div class="relative z-10 text-center max-w-md">
                <div class="mb-8">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="LOKAL Logo" class="h-20 w-auto mx-auto brightness-0 invert">
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-sm">
                ...
                <div class="lg:hidden text-center mb-8">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="LOKAL Logo" class="h-14 w-auto mx-auto mb-3">
                ...
                <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm font-medium text-red-700"><?php echo e($errors->first('email')); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                    <p class="text-sm font-medium text-green-700"><?php echo e(session('status')); ?></p>
                </div>
                <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>"
                                   class="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password"
                                   class="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                <p class="mt-8 text-center text-xs text-gray-400">
                    &copy; <?php echo e(date('Y')); ?> LOKAL App. Hanya untuk admin terdaftar.
                </p>
            </div>
        </div>
...
</html><?php /**PATH D:\laragon\www\ekonomi_lokal\backend\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>