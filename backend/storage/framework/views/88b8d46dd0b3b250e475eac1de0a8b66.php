...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border border-blue-200 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-blue-600">Rp <?php echo e(number_format($summary['total_commission_admin'], 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-5 border border-emerald-200 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-emerald-600">Rp <?php echo e(number_format($summary['total_cash_umkm'], 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-5 border border-amber-200 shadow-sm">
            ...
            <p class="text-2xl font-extrabold text-amber-600"><?php echo e(number_format($summary['total_coin'], 0, ',', '.')); ?> 🪙</p>
            <p class="text-xs text-amber-500">~ Rp <?php echo e(number_format($summary['total_coin'] * 10, 0, ',', '.')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="font-semibold text-gray-900">Semua Wallet (<?php echo e($wallets->total()); ?>)</h3>
            <span class="text-xs text-gray-400">Total cash: Rp <?php echo e(number_format($summary['total_cash'], 0, ',', '.')); ?></span>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="font-medium text-gray-900"><?php echo e($wallet->user->name ?? '—'); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($wallet->user->email ?? ''); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            <?php
                            ...
                            ?>
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($roleColors[$wallet->user->role] ?? 'bg-gray-100'); ?>">
                                <?php echo e($roleLabels[$wallet->user->role] ?? $wallet->user->role); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 font-mono font-medium">Rp <?php echo e(number_format($wallet->cash_balance, 0, ',', '.')); ?></td>
                        <td class="px-6 py-4 font-mono">Rp <?php echo e(number_format($wallet->commission_balance, 0, ',', '.')); ?></td>
                        <td class="px-6 py-4 font-mono"><?php echo e(number_format($wallet->coin_balance, 0, ',', '.')); ?> 🪙</td>
                        <td class="px-6 py-4 font-mono font-bold text-gray-900">Rp <?php echo e(number_format($totalValue, 0, ',', '.')); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\ekonomi_lokal\backend\resources\views/admin/wallets/index.blade.php ENDPATH**/ ?>