    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden lg:flex lg:flex-col w-64 sidebar-gradient text-white flex-shrink-0">
            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="sidebar-item active flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium">
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr class="hover:bg-gray-50/50">
                                    <td class="px-5 py-3.5 font-mono text-xs text-gray-700"><?php echo e($setting->key); ?></td>
                                    <td class="px-5 py-3.5 font-medium text-gray-900"><?php echo e($setting->label ?? '-'); ?></td>
                                    <td class="px-5 py-3.5">
                                        <span class="px-2.5 py-1 bg-blue-50 text-blue-700 font-semibold rounded-lg"><?php echo e($setting->value); ?></span>
                                    </td>
                                    <td class="px-5 py-3.5">
                                        <span class="px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded-full"><?php echo e($setting->group); ?></span>
                                    </td>
                                    <td class="px-5 py-3.5">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin.settings.destroy', $setting->id)); ?>"
                                                onsubmit="return confirm('Hapus pengaturan <?php echo e($setting->label ?: $setting->key); ?>?')">
                                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\laragon\www\LOKAL_APP\backend\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>