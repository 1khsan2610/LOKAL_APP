...
<body class="bg-gray-50 text-gray-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 text-white text-sm font-semibold rounded-xl hover:bg-gray-800 transition-all duration-200 shadow-sm">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-8">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-all shadow-lg shadow-white/10">
                            Masuk ke Dashboard
                ...
                <div class="bg-blue-50 rounded-3xl p-8 lg:p-10 border border-blue-100">
                    <div class="grid grid-cols-2 gap-5">
                        <div class="bg-white rounded-2xl p-5 text-center shadow-sm">
                            ...
                            <div class="text-2xl font-extrabold text-gray-900">{{ $stats['total_umkm'] ?? '500+' }}</div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                ...
                <div class="card-hover bg-white rounded-2xl p-6 text-center border border-gray-100 shadow-sm">
                    @php $photoPath = public_path('images/team/' . $member['photo']); @endphp
                    @if(file_exists($photoPath) && $member['photo'])
                    ...
                    @endif
                    <h3 class="font-semibold text-sm text-gray-900 leading-tight">{{ $member['name'] }}</h3>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-center text-sm">© {{ date('Y') }} LOKAL App. All rights reserved.</p>
        </div>
    </footer>
